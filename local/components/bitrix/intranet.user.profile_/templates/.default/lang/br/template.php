...
$MESS["INTRANET_USER_PROFILE_CONFIRM_NO"] = "Não";
$MESS["INTRANET_USER_PROFILE_CONFIRM_NO_MSGVER_1"] = "Não";
$MESS["INTRANET_USER_PROFILE_CONFIRM_YES"] = "Sim";
...
$MESS["INTRANET_USER_PROFILE_INTEGRATOR_ERROR_NOT_PARTNER"] = "O usuário não é certificado e, portanto, não pode ser um Parceiro Bitrix24. Os parceiros têm acesso ao seu Bitrix24, razão pela qual apenas os funcionários de empresas confiáveis ​​podem obter o status de Parceiro Bitrix24.
<br/><br/>
As permissões de nível de parceiro são suficientes para instalar e configurar seu Bitrix24. Aconselhamos fortemente não conceder acesso de administrador a terceiros, pois eles podem dispensar acidentalmente ou maliciosamente todos os funcionários e obter controle total do seu Bitrix24.
<br/><br/>
...
$MESS["INTRANET_USER_PROFILE_MOVE_ADMIN_RIGHTS_SECURITY_CONFIRM_DESCRIPTION"] = "Os administradores têm acesso total às informações pessoais do usuário e do cliente. Eles podem convidar e descartar usuários e funcionários; alterar permissões de usuário e configurações do Bitrix24. Deseja tornar este usuário um administrador?";
$MESS["INTRANET_USER_PROFILE_MOVE_ADMIN_RIGHTS_SECURITY_CONFIRM_DESCRIPTION_MSGVER_1"] = "Os administradores têm acesso total às informações pessoais dos usuários e clientes. Eles podem convidar e descartar usuários e funcionários; alterar permissões de usuário e configurações do Bitrix24. Deseja tornar este usuário um administrador?";
...
$MESS["INTRANET_USER_PROFILE_MSG_1_invited"] = "O convite não foi aceito.";
