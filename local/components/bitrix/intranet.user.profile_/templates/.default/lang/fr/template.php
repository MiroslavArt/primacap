<?php
$MESS["INTRANET_USERPROFILE_ACTION_REFUSE"] = "Refuser";
$MESS["INTRANET_USER_FIILDS_SETTINGS"] = "Paramètres d'affichage du champ";
$MESS["INTRANET_USER_PROFILE_ACTION_CONFIRM"] = "Confirmer la connexion";
...
$MESS["INTRANET_USER_PROFILE_CONFIRM_NO"] = "Non";
$MESS["INTRANET_USER_PROFILE_CONFIRM_NO_MSGVER_1"] = "Non";
$MESS["INTRANET_USER_PROFILE_CONFIRM_YES"] = "Oui";
$MESS["INTRANET_USER_PROFILE_CONFIRM_YES_INTEGRATOR"] = "Attribuer le statut de partenaire";
$MESS["INTRANET_USER_PROFILE_CONFIRM_YES_MSGVER_1"] = "Oui";
...
$MESS["INTRANET_USER_PROFILE_DISK_INSTALLED_MSGVER_2"] = "Bitrix24 Drive installé le #DATE#";
$MESS["INTRANET_USER_PROFILE_DISK_SPACE"] = "espace disque : #VALUE#";
$MESS["INTRANET_USER_PROFILE_DISK_SPACE_MSGVER_1"] = "Bitrix24 Drive installé le #DATE#, taille totale #VALUE#";
...
$MESS["INTRANET_USER_PROFILE_FIRE_INVITED_USER"] = "Vous ne pouvez pas supprimer l'utilisateur invité de Bitrix24, car il y a des liaisons vers d'autres entités. Désactivez (masquez) l'utilisateur pour fermer l'accès à ce compte Bitrix24.
<br><br>Voulez-vous rejeter l'utilisateur ?";
...
$MESS["INTRANET_USER_PROFILE_INTEGRATOR_ERROR_NOT_PARTNER"] = "L'utilisateur n'est pas certifié et ne peut donc pas être un partenaire Bitrix24. Les partenaires ont accès à votre compte Bitrix24, c'est pourquoi seuls les employés des entreprises de confiance peuvent obtenir le statut de partenaire Bitrix24.
<br/><br/>
Les autorisations de niveau partenaire sont suffisantes pour configurer votre compte Bitrix24. Nous déconseillons fortement d'accorder l'accès à des tiers administrateurs, car ils peuvent accidentellement ou malicieusement renvoyer tous les employés et obtenir le contrôle total de votre compte Bitrix24.
<br/><br/>
Sélectionnez un partenaire Bitrix24 avec lequel vous souhaitez travailler <a target=\"_blank\" href=\"https://www.bitrix24.fr/partners/\" >ici</a>.";
...
$MESS["INTRANET_USER_PROFILE_MOVE_ADMIN_RIGHTS_SECURITY_CONFIRM_DESCRIPTION"] = "Les administrateurs ont un accès complet aux informations personnelles des utilisateurs et des clients. Ils peuvent inviter et rejeter les utilisateurs et les employés, et modifier les autorisations des utilisateurs et les paramètres de Bitrix24. Voulez-vous faire de cet utilisateur un administrateur ?";
$MESS["INTRANET_USER_PROFILE_MOVE_ADMIN_RIGHTS_SECURITY_CONFIRM_DESCRIPTION_MSGVER_1"] = "Les administrateurs ont un accès complet aux informations personnelles des utilisateurs et des clients. Ils peuvent inviter et renvoyer les utilisateurs et les employés, et modifier les autorisations des utilisateurs et les paramètres de Bitrix24. Voulez-vous faire de cet utilisateur un administrateur ?";
$MESS["INTRANET_USER_PROFILE_MOVE_ADMIN_RIGHTS_SECURITY_CONFIRM_TITLE"] = "Assigner l'utilisateur en tant qu'administrateur";
...
$MESS["INTRANET_USER_PROFILE_MSG_1_invited"] = "L'invitation n'a pas été acceptée.";
...
$MESS["INTRANET_USER_PROFILE_SAVE"] = "Enregistrer";
...
$MESS["INTRANET_USER_PROFILE_SET_INTEGRATOR_RIGHTS_CONFIRM"] = "Les partenaires Bitrix24 certifiés peuvent vous aider à configurer et ajuster votre Bitrix24 (CRM, canaux ouverts, documentation, téléphonie, rapports et autres outils commerciaux) pour qu'il fonctionne avec les processus d'entreprise de votre entreprise. 
...
$MESS["INTRANET_USER_PROFILE_waiting"] = "En attente de confirmation de connexion";
