...
<div id="uiToolbarContainer" class="ui-toolbar"><?php
	...
	if($filter <> ''):
		...
		?></div><a class="ui-btn ui-btn-success" onclick="return confirm('Are you sure you want to submit the quotation?')" href="/local/approve_quotation.php?id=<?=$arParams['ELEMENT_ID']?>" title="Boost">Boost</a><?php
	endif;
