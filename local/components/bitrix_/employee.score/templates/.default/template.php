...
/*------------------------Reactiveness------------------------------*/
$strreactSql = $DB->Query("Select count(*) as reactivities_count from c_distribution_lead_missing where USER_ID = '".$arRes['ID']."'  and MISSED_AT between '".$fromdate."' and '".$todate."' ");
$reactRes = $strreactSql->Fetch();

$strreactSqltot = $DB->Query("Select count(*) as reactivities_count from c_distribution_lead_missing  where MISSED_AT between '".$fromdate."' and '".$todate."' ");
...
<td align='center' style='border:1px #f5f9f9 solid;width:5%;'><?=$leadconvRes['lead_convertion_count'];?></td>
...
<td align='center' style="border:1px #f5f9f9 solid;width:5%; <? if($reactRes['reactivities_count']>0){ ?>color:red;<?}?>"><?=$reactRes['reactivities_count'];?></td>
<td align='center' style="border:1px #f5f9f9 solid;width:5%; <? if($reactRes['reactivities_count']>0){ ?>color:red;<?}?>"><?=$reactper;?></td>
<td align='center' style='border:1px #f5f9f9 solid;width:5%;'><?=$stractleadRes['act_lead_count'];?></td>
<td align='center' style='border:1px #f5f9f9 solid;width:5%;'><?=$stractleadper;?></td>
<td align='center' style='border:1px #f5f9f9 solid;width:5%;'><?=$strjunkleadRes['junk_lead_count'];?></td>
