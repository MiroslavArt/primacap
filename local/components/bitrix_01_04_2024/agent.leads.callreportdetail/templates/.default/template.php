...
{
/*------------------------Active Leads------------------------------*/
$leadsSql = $DB->Query("Select ID,TITLE,STATUS_ID from b_crm_lead where ASSIGNED_BY_ID = '".$_REQUEST['ASSIGNED_BY_ID']."' and STATUS_ID IN ('NEW','UC_0L8X7G','UC_9WUJ49','UC_23YNYD','UC_TCX0EY','IN_PROCESS','UC_OD8Y57','UC_TB6VLO','UC_ZCVQ0B','UC_6QWK0K',7,'UC_U2UJ60') ");
}
...
<td align='center' style="border:1px #f5f9f9 solid;width:5%;background:<?=$istrleadSqlRes['COLOR'];?>"><?=$istrleadSqlRes['STATUS_NAME'];?></td>
