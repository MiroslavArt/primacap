...
<?if($USER->IsAdmin()) { ?>
 <div class="widget">
        <h2>Company Project Leads from Different Sources Report</h2>
<p><a href="/local/custom-reports/project-leads-from-sources/"><i class="fa fa-file"> View Report</i></a></p>
    </div>
 <div class="widget">
        <h2>Company Campaign Leads Report</h2>
<p><a href="/local/custom-reports/campaign-leads/"><i class="fa fa-file"> View Report</i></a></p>
    </div>
<div class="widget">
        <h2>Boost Score</h2>
		<p><a href="/local/custom-reports/boost-score/"><i class="fa fa-file"> View Report</i></a></p>
    </div>
	<? } ?>
</div>
