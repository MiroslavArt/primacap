...
$MESS[$MODULE_ID.'_Lead_AssignedTo'] = 'Employee ID to which new lead is assigned to';
$MESS[$MODULE_ID.'_Bayut_Source'] = 'Bayut deal source';
$MESS[$MODULE_ID.'_Dubizzle_Source'] = 'Dubizzle deal source';
