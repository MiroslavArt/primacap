...
//file_put_contents($_SERVER['DOCUMENT_ROOT'] .'/local/php_interface/lib/vendor/mesilov/bitrix24-php-sdk/src/logNew.txt',date('H:i:s d.m.y').' : '. var_export($curlResult,true).PHP_EOL,FILE_APPEND);
