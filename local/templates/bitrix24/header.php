...
.red {
        background-color: #e90000de;
color: #fff;
}
.yellow {
        background-color: #faff00f5;
color: #000;
}
.green {
        background-color: #026404de;
}
...
<? if($metrics['lead_conversion']>='3'){?>
  <div class="floating-div green">
        <b>Congratulations! </b> You have closed more than 3 deals in the last 90 days. Keep up the good work and try to close even more deals.
</div>
<? } elseif($metrics['lead_conversion']>='1'){ ?>
  <div class="floating-div yellow">
<b>Congratulations!</b> You have closed below 3 deals in the last 90 days. Keep up the good work and try to close even more deals.
</div>
<? } else{ ?>
  <div class="floating-div red">
<b>Attention :</b> You have not closed any deals in the last 90 days. Try to close some deals.
</div>
        <? }?>
<div class="root">
